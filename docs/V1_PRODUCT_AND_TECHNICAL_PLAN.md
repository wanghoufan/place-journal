...
>
> **状态**：已实现 M0–M6 全量并通过 L2 云同步实测（2026-09-04，见 `docs/handoff/HANDOFF.md` §0）；单设备定位，ENV-1 Storage 已关闭；主题/分享长图/标签真删/Find 分离等扩展以代码与 HANDOFF §0 为准，SSOT 行为规格不变。
>
> **版本**：V1.0 · 2026-09-01（SSOT 行为规格不变；实现状态见 HANDOFF）
